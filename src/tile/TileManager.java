...
public class TileManager {
    ...
    public TileManager(GamePanel gp){
        ...
        getTileImage();
        loadMap("/world01/worldV3.txt",0);
        loadMap("/world01/interior01.txt",1);
    ...
    public void setup(int index, String imageName, boolean collision){
        ...
        try{
            tile[index] = new Tile();
            tile[index].image = ImageIO.read(getClass().getResourceAsStream("/restiles/" + imageName + ".png"));
    ...
    public void loadMap(String filePass, int map){

        try{
            InputStream is = getClass().getResourceAsStream(filePass);
            BufferedReader br = new BufferedReader(new InputStreamReader(is)); // used to read the content of the text file
            ...
            while( col < gp.maxWorldCol && row < gp.maxWorldRow) {
                ...
                String line = br.readLine(); //read a single line in the txt
...
/*  MY EFFORTT!!!!
        ...
        g2.drawImage(tile[2].image, 96, 48 , gp.tileSize, gp.tileSize, null);
