...
public class UI {
    ...
    //ALWAYS INSTANTIATE HERE THEN use constructor
    GamePanel gp;
    Graphics2D g2;
    Font arial_40;
    BufferedImage heart_full, heart_half, heart_blank, crystal_full, 
    crystal_blank, coin;
   ...
   // public String message = "";
    ...
    // TIPS NEVER INSTANTIATE INSIDE A METHOD
    ...
    public void drawMessage(){
        ...
        for(int i = 0 ; i < message.size() ; i++){
            ...
            if(message.get(i) != null){
                ...
                int counter = messageCounter.get(i) + 1; // basically means messageCounter++
    ...
    public void drawTitleScreen(){
        ...
        String text = "My Nigga Adventure!";
    ...
    public void drawSubWindow(int x, int y, int width, int height){
        ...
        Color c = new Color(0, 0, 0,210); //transparency for 4th num
        g2.setColor(c);
 ...
 * else if(titleScreenState == 1){
            ...
            String text = "Select your nigger!";
            int x = getXforCenteredText(text);
            int y = gp.tileSize*3;
            g2.drawString(text,x ,y);
